        ...
        if (organico.containsKey(chiave(nome.toLowerCase(), cognome.toLowerCase()))) {
            ...
            switch (ruolo) {
                ...
                case "sviluppatore":
                    ...
                    Sviluppatore dev = new Sviluppatore(nome, cognome, dob, email, tel, ruolo, tester, repart, id1, linguaggio);
                    ...
                    case "ruolo":
                        ...
                        switch (ruolo) {
                            ...
                            case "dirigente":
                                ...
                                byte resp = (byte) scan.nextInt();
                                scan.nextLine();
                                Dirigente dir = new Dirigente(organico.get(key).getNome(), organico.get(key).getCognome(), organico.get(key).getDob(), organico.get(key).getEmail(), organico.get(key).getNumTel(), ruolo, organico.get(key).getTesterBool(), reparto, id, resp);
                                organico.remove(key);
                            ...
                            case "sviluppatore":
                                ...
                                System.out.print("Inserire il linguaggio di programmazione:\t");
                                String linguaggio = new String(scan.nextLine());
                                Sviluppatore dev = new Sviluppatore(organico.get(key).getNome(), organico.get(key).getCognome(), organico.get(key).getDob(), organico.get(key).getEmail(), organico.get(key).getNumTel(), ruolo, organico.get(key).getTesterBool(), reparto1, id1, linguaggio);
                                organico.remove(key);
                            ...
                            case "risorse umane":
                                System.out.print("Inserire La mansione:\t");
                                String mansione = new String(scan.nextLine());
                                RisorseUmane hr = new RisorseUmane(organico.get(key).getNome(), organico.get(key).getCognome(), organico.get(key).getDob(), organico.get(key).getEmail(), organico.get(key).getNumTel(), ruolo, organico.get(key).getTesterBool(), mansione);
                                organico.remove(key);
                                organico.put(chiave(hr.getNome(), hr.getCognome()), hr);
                                break;

                            default:
                                Dipendente dip = new Dipendente(organico.get(key).getNome(), organico.get(key).getCognome(), organico.get(key).getDob(), organico.get(key).getEmail(), organico.get(key).getNumTel(), ruolo, organico.get(key).getTesterBool());
                                organico.remove(key);
